...
const MissionManagerTest::TestCase_t MissionManagerTest::_rgTestCases[] = {
    ...
    { "5\t0\t3\t31000\t10\t20\t30\t40\t-10\t-20\t-30\t1\r\n",   { 5, QGeoCoordinate(-10.0, -20.0, -30.0), MAV_CMD_NAV_ENTER_STALL,  10.0, 20.0, 30.0, 40.0, true, false, MAV_FRAME_GLOBAL_RELATIVE_ALT } },
    { "6\t0\t3\t31001\t10\t20\t30\t40\t-10\t-20\t-30\t1\r\n",   { 6, QGeoCoordinate(-10.0, -20.0, -30.0), MAV_CMD_NAV_STALL,        10.0, 20.0, 30.0, 40.0, true, false, MAV_FRAME_GLOBAL_RELATIVE_ALT } },
    { "7\t0\t2\t112\t10\t20\t30\t40\t-10\t-20\t-30\t1\r\n",     { 7, QGeoCoordinate(-10.0, -20.0, -30.0), MAV_CMD_CONDITION_DELAY,  10.0, 20.0, 30.0, 40.0, true, false, MAV_FRAME_MISSION } },
};
